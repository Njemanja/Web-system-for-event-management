...
let UslugaComponent = class UslugaComponent {
    constructor(elementRef, renderer, servis, router) {
        ...
        this.okrugliStolovi = [];
        this.pravougaoniStolovi = [];
    }
    ngOnInit() {
        this.id = parseInt(localStorage.getItem("usluga"));
        this.stolovi = [];
        this.servis.dohvatiUslugu(this.id).subscribe((usluga) => {
            this.ime = usluga.ime;
...
], UslugaComponent.prototype, "canvasDiv", void 0);
UslugaComponent = __decorate([
    Component({
        selector: 'app-usluga',
...
export { UslugaComponent };
//# sourceMappingURL=usluga.component.js.map